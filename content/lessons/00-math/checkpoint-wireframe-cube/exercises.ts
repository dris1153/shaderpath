...
requestAnimationFrame(draw);`,
    ...
    checklist: [
      ...
      {
        vi: "12 cạnh nối đúng 8 đỉnh theo danh sách EDGES, không bị chéo hay thiếu cạnh nào",
        en: "All 12 edges connect the correct pairs from the 8 vertices per the EDGES list, none crossed or missing",
      },
      {
        vi: "Animation chạy mượt 60fps bằng requestAnimationFrame, không dùng setInterval",
        en: "Animation runs a smooth 60fps via requestAnimationFrame, not setInterval",
      },
    ],
  },
];
