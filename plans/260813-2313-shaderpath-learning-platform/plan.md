...
| 2 | Content pipeline: MDX + KaTeX + shiki, `LessonMeta`, `curriculum.ts` (13 tracks, metadata only) | Not Started | 10h | [phase-02](phase-02-content-pipeline-mdx-katex-shiki-curriculum.md) |
